      ...
      if (errorFields.isNotEmpty) {
        ...
        if (notifierType == LzFormNotifier.toast) {
          LzToast.show(errorMessage,
              placement: toastPosition ?? LzToast.config.placement);
...
class LzFormList extends StatelessWidget {
  ...
  /// If true, the form will be cleared from errors messages when the form is filled
  final bool cleanOnFilled;
