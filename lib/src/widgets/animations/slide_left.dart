...
///
/// The `SlideLeft` widget is used to create smooth sliding animations for its child widget.
/// It animates the child widget's position from the right to its original position.
///
/// Example usage:
/// ```dart
/// SlideLeft(
...
///   child: Text('Slide left animation'), // The child widget to be animated
/// )
/// ```
class SlideLeft extends StatefulWidget {
  ...
  /// Creates a `SlideLeft` widget.
  ///
  /// The [child] is the widget to be animated with a sliding left animation.
