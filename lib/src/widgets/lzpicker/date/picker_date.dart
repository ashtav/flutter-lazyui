...
class LzDatePicker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> months = monthsList.map((e) => useShortMonths ? e.substring(0, 3) : e).toList();
    ...
    DatePickerNotifier notifier = DatePickerNotifier({'month': months[init.month - 1], 'year': init.year});
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyMedium
                                        ?.copyWith(fontWeight: Fw.bold, color: LzColors.black),
                                  ),
                                ));
                          }),
                        ),
