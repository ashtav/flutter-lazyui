            ...
            (state) {
              ...
              return Intrinsic(
                  ...
                  children: [start, '-', end].generate((text, i) {
                    ...
                    Color textColor = state.dateIndex == ii ? Colors.orange : isDarkMode ? Colors.white : Colors.black54;
                    ...
                    return Expanded(
                      ...
                      child: InkTouch(
                        ...
                        child: Center(
                            child: isTo
                                ? Icon(arrow, color: isDarkMode ? Colors.white : Colors.black38)
                                : Text(text, style: Gfont.color(textColor).fbold(state.dateIndex == ii))),
                      ),
                    );
                  }));
            },
