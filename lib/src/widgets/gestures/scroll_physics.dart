...
class Scrolics {
  ...
  static ScrollPhysics get bounce =>
  ...
  static ScrollPhysics get always =>
  ...
  static ScrollPhysics get never =>
      NeverScrollableScrollPhysics(parent: AlwaysScrollableScrollPhysics());

  /// Creates a scroll physics designed for page-based scrolling
  /// (commonly used in [PageView]).
  static ScrollPhysics get page =>
  ...
  static ScrollPhysics get range =>
      RangeMaintainingScrollPhysics(parent: AlwaysScrollableScrollPhysics());

  /// Creates a scroll physics that enforces fixed scrolling steps,
  /// typically used with [ListWheelScrollView].
  static ScrollPhysics get fixed =>
      FixedExtentScrollPhysics(parent: AlwaysScrollableScrollPhysics());
}
