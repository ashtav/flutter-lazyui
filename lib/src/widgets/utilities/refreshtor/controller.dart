...
class IndicatorController extends Animation<double>
  ...
  /// Creates [Refreshtor] controller class
  ...
  ///
  /// This is especially useful with [Refreshtor.trigger]
  ...
  /// the [Refreshtor] widget.
  IndicatorEdge? get edge => _edge;
  IndicatorEdge? _edge;

  /// Whether the [edge] was determined by the [Refreshtor] widget.
  ...
  /// Describes current [Refreshtor] state
