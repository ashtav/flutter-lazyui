...
import 'option_picker_style.dart';
...
class _PickerOptionWidgetState extends State<PickerOptionWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    IconData searchIcon = ConfigIcon.get(IconSet.search);
        ...
        child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              ...
              // title & description
              // if (widget.style?.title != null && widget.style?.withSearch == false)
              //   Poslign(
              //       alignment: Alignment.topLeft,
              //       margin: Ei.all(20),
              //       child: Column(
              ...
              //           if (widget.style?.description != null) Text(widget.style!.description!, style: font.fs14.muted),
              //         ],
    ...
    return Touch(
        ...
        child: Container(
          ...
          child: Text(
            ...
            maxLines: 1,
            overflow: Tof.ellipsis,
            style: config.font.copyWith(fontWeight: Fw.bold, color: Colors.black87),
          ),
        ));
  }
}
