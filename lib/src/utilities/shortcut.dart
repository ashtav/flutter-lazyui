...
class Br {
  ...
  static BoxBorder all(
    ...
    return Border.all(
        ...
        width: width ?? config.borderWidth,
        style: style,
  ...
  static BoxBorder except(List<String> except,
    ...
    return Border(
        top: except.contains('t') ? BorderSide.none : borderSide,
        bottom: except.contains('b') ? BorderSide.none : borderSide,
        left: except.contains('l') ? BorderSide.none : borderSide,
        right: except.contains('r') ? BorderSide.none : borderSide);
  }
