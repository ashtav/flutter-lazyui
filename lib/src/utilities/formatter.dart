...
class Formatter {
  ...
  static TextInputFormatter get email => FilteringTextInputFormatter.allow(RegExp("[a-zA-Z0-9@._-]"));
  ...
  /// )
  /// ```
  static TextInputFormatter currency([String separator = ',']) => _ThousandFormatter(separator: separator);
  ...
  TextEditingValue formatEditUpdate(TextEditingValue oldValue, TextEditingValue newValue) {
    if (newValue.text.isEmpty) {
      ...
      String convert(String value) {
        return NumberFormat.currency(locale: 'id_ID', decimalDigits: 0, symbol: '').format(value.numeric);
      }
