...
class Lazy {
  ...
  static TextStyle textStyle(BuildContext context) => _defaultTextStyle ?? Theme.of(context).textTheme.bodyMedium ?? GoogleFonts.nunitoSans(fontSize: 15.5, color: LzColors.black);
